...
public static void loginPressed(){
    ...
    public static void actionsPanel(){
        ...
        endSub.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                actionsFrame.setVisible(false);
                endSubPanel();
    ...
    public static void endSubPanel(){
        final String[] promoteAnswer = new String[1];
        promoteAnswer[0] = "none";
        JFrame endSubFrame = new JFrame("End subscription of Client");
        endSubFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        endSubFrame.setSize(500, 500);
        JLabel mainLabel = new JLabel("Enter the client's details!");
        mainLabel.setFont(new Font("Serif", Font.BOLD, 20));
        mainLabel.setBounds(130, 10, 300, 50);
        endSubFrame.add(mainLabel);

        JLabel nameLabel = new JLabel("Client name");
        JTextField nameTf = new JTextField(20);
        nameLabel.setBounds(50, 180, 100, 40);
        nameTf.setBounds(250, 180, 100, 40);
        endSubFrame.add(nameLabel);
        endSubFrame.getContentPane().add(nameTf);
        ...
        endSubFrame.add(phoneLabel);
        endSubFrame.getContentPane().add(phoneTf);

        JButton end = new JButton("Good Bye");
        end.setBounds(200, 360, 100, 50);
        endSubFrame.getContentPane().add(end);
        endSubFrame.setLayout(null);
        endSubFrame.setVisible(true);

        end.addActionListener(new ActionListener() { //end subscription
            @Override
            public void actionPerformed(ActionEvent e) {
                Socket connection = null;
                Socket connection2 = null;
                try {
                    ...
                    os.write(3);
                    connection.close();
                    connection2 = new Socket("localhost", 3000);
                    OutputStream os2 = connection2.getOutputStream();
                    DataOutputStream  dos2 = new DataOutputStream(os2);
                    InputStream is2 = connection2.getInputStream();
                    DataInputStream dis2 = new DataInputStream(is2);
    ...
    public static void signNewClientPanel (){
        ...
        sign.addActionListener(new ActionListener() { //sign new client
            @Override
            public void actionPerformed(ActionEvent e) {
                Socket connection = null;
                Socket connection2 = null;
